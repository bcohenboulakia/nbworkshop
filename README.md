...
- [Solutions format](#solutions-format)
  - [Solutions in Code cells](#solutions-in-code-cells)
  - [Solutions in Markdown cells](#solutions-in-markdown-cells)
 ...
 * `--config` (optional): Specify alternative config path (default: `./config.json`, but the GitHub workflow uses `.github/conversion.json`)
