...
The conversion is managed by a GitHub workflow called `Students Notebook generation`. This workflow uses two branches to generate student notebooks (but as many branches as needed can be created, they will just be ignored):
